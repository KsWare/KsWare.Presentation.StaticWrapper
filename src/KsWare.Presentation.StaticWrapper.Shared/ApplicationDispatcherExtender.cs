...
namespace KsWare.Presentation.StaticWrapper {
	...
	public sealed class ApplicationDispatcherExtender {
		...
		[Browsable(false)]
		[EditorBrowsable(EditorBrowsableState.Never)]
		public object Invoke(DispatcherPriority priority, Delegate method, object arg) => Dispatcher.Invoke(priority, method, arg);
		...
		public object Invoke(DispatcherPriority priority, Delegate method, object arg, params object[] args) =>
			Dispatcher.Invoke(priority, method, arg, args);
		...
		public object Invoke(DispatcherPriority priority, TimeSpan timeout, Delegate method) =>
			Dispatcher.Invoke(priority, timeout, method);
		...
		public object Invoke(DispatcherPriority priority, TimeSpan timeout, Delegate method, object arg) =>
			Dispatcher.Invoke(priority, timeout, method, arg);
		...
		public object Invoke(DispatcherPriority priority, TimeSpan timeout, Delegate method, object arg,
			params object[] args) =>
			Dispatcher.Invoke(priority, timeout, method, arg, args);
		...
		public object Invoke(Delegate method, TimeSpan timeout, DispatcherPriority priority, params object[] args) =>
			Dispatcher.Invoke(method, timeout, priority, args);
		...
		public Task<TResult> RunAsync<T1, T2, TResult>(T1 p1, T2 p2, Func<T1, T2, TResult> func) =>
			Dispatcher.InvokeAsync(() => func(p1, p2)).Task;
